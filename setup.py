...
requirements = [
        ...
        'line_profiler42 ;   platform_system == "Linux"',   # For the line profiler -- only install on Linux
...
setup(
    ...
    dependency_links = [
     'git+https://github.com/Theelx/line_profiler.git@main#egg=line_profiler42',
    ],
